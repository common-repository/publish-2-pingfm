...
if (!class_exists("Publish2PingFM")) {
	class Publish2PingFM {
		 ...
		 * Since 1.1, also loads translations
		 * 
		 * @since 0.1
		 */
		public function init() {
			...
			load_plugin_textdomain('publish2pingfm',false,$publish2pingfm_plugin_url . 'languages');
			
//			$currentLocale = get_locale();
//			if(!empty($currentLocale)) {
//				$moFile = dirname(__FILE__) . "../languages/publish2pingfm-" . $currentLocale . ".mo";
//				if(@file_exists($moFile) && is_readable($moFile)) load_textdomain('publish2pingfm', $moFile);
//			}
